...
Мониторинг птиц у кормушек, в саду и на площадках: компьютерное зрение и аудио для детекции, идентификации, записи и анализа визитов — для орнитологии, гражданской науки и операторов, которые держат данные на своём железе. Docker на Jetson Nano; интеграции с Go2RTC, Frigate, BirdNET по MQTT. Ядро обработки без облака вендора.
