# Настройка MCP BirdLense

MCP (Model Context Protocol) позволяет Cursor и другим AI-агентам вызывать API BirdLense.
...
1. Откройте BirdLense → Настройки
...
Замените:
- `192.168.1.11:8085` — IP и порт вашего BirdLense
