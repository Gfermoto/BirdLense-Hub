...
Formats, scripts, sources, and training hardware. **End-to-end training:** [TRAINING](../../archive/internal/docs-legacy/TRAINING.md).

[Русский](../contributor/datasets.md)
...
| Classifier merged dirs (local) | Often repo-root `datasets/merged_cls/` etc. — gitignored; see [TRAINING](../../archive/internal/docs-legacy/TRAINING.md) |
...
in [CV_ML_PREP](../../archive/internal/docs-legacy/CV_ML_PREP.md) in sync with this page. In short: first-stage
...
Colab flow for this ZIP + **`bl_best.pt`**: [ML_DETECTOR_COLAB.md](../../archive/internal/docs-legacy/ML_DETECTOR_COLAB.md). Scripts: **`scripts/datasets/README.md`**.
...
**Practical default:** Colab Free (T4) — see [TRAINING](../../archive/internal/docs-legacy/TRAINING.md).
...
| Platform | Use |
|----------|-----|
| **Hugging Face** | [gfermoto/birds-eu-merged](https://huggingface.co/datasets/gfermoto/birds-eu-merged), [gfermoto/birdlense-birds-eu](https://huggingface.co/gfermoto/birdlense-birds-eu) — see [TRAINING](../../archive/internal/docs-legacy/TRAINING.md) |
...
[TRAINING](../../archive/internal/docs-legacy/TRAINING.md) · [FEATURES](../user/features.md) · [CONFIGURATION](../user/configuration.md)
