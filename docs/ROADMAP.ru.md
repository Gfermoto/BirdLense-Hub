...
**Архитектура и сопровождаемость (следующая волна, апр. 2026):** на той же доске [BirdLense Hub — Roadmap](https://github.com/users/Gfermoto/projects/2) — [#292](https://github.com/Gfermoto/BirdLense-Hub/issues/292) (декомпозиция `app/web/app.py`), [#293](https://github.com/Gfermoto/BirdLense-Hub/issues/293) (сервисный слой / тонкие роуты), [#281](https://github.com/Gfermoto/BirdLense-Hub/issues/281) (Pydantic на mutating API), [#294](https://github.com/Gfermoto/BirdLense-Hub/issues/294) (N+1 / индексы), [#295](https://github.com/Gfermoto/BirdLense-Hub/issues/295) (DI процессора), [#296](https://github.com/Gfermoto/BirdLense-Hub/issues/296) (состояние UI / TanStack Query), [#297](https://github.com/Gfermoto/BirdLense-Hub/issues/297) (CI: сложность, OpenAPI→TS; политика npm audit → **#284** ✅). **Security / hardening:** [#277](https://github.com/Gfermoto/BirdLense-Hub/issues/277)–[#286](https://github.com/Gfermoto/BirdLense-Hub/issues/286). **#284** ✅ **закрыт** — по расписанию **npm audit** для `app/ui`; [TESTING.ru.md](./TESTING.ru.md). **#287** ✅ **закрыт** — аудит: в `create_app`/рантайме web нет `ALTER TABLE`; DDL только через Alembic; см. [ARCHITECTURE.ru.md](./ARCHITECTURE.ru.md) § База данных.
