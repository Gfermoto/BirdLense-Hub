...
| 18  | **ML / видео: распознавание действий** птицы (прилёт, отлёт, кормление, питьё, драка и т.п.) — **любая** установка: кормушка, парк/заповедник с IP-камерой и др.; отдельно от классификации вида по кадру | [#379](https://github.com/Gfermoto/BirdLense-Hub/issues/379) — эпик/исследование; рядом: [#157](https://github.com/Gfermoto/BirdLense-Hub/issues/157) (запись), [#164](https://github.com/Gfermoto/BirdLense-Hub/issues/164) (виды). **Research:** [§ ниже](#bird-behavior-ml-research) | P3, processor, ML, research |
