...
|-------------|-------------|
| **Visual WetlandBirds** (2025, [Scientific Data](https://www.nature.com/articles/s41597-025-05516-5), [arXiv](https://arxiv.org/abs/2501.08931), [код](https://github.com/3dperceptionlab/visual-wetlandbirds)) | **178** роликов, **858** клипов поведения (~**20 с** среднее, ~**59 мин** суммарно), **13** видов, **7** поведений: Alert, Feeding, Flying, Preening, Resting, Swimming, Walking — bbox **по кадрам** + вид. Бейзлайны поведения (accuracy): Video ResNet **0,56**, MViT/Swin **0,51**, TimeSFormer **0,49**, S3D **0,29**; детекция вида (YOLOv9): mAP50 **0,801**. Домен — валуны Испании, **не** кормушка. Подробности и ссылки — [#379](https://github.com/Gfermoto/BirdLense-Hub/issues/379). |
