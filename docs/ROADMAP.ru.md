...
- [#167](https://github.com/Gfermoto/BirdLense-Hub/issues/167) — **открыт:** базовая интеграция весов уже в релизе; в backlog — триггер по резкому изменению веса (и опционально auto-tare / детекции).
...
| 17  | Весы: MQTT/HA + UI в релизе; дальше — **триггер по резкому изменению веса** (опционально auto-tare + детекции)                             | [#167](https://github.com/Gfermoto/BirdLense-Hub/issues/167) открыт | P3, processor, research                                      |
