...
[English](../contributor/security.md)
...
Ключи: [CONFIGURATION.ru.md](./configuration.ru.md) (`BIRDLENSE_HIDE_DIRECT_RECORDINGS`, `require_auth_for_video_stream`). Деплой: [DEPLOY_SERVER.ru.md §8](./deploy-server.ru.md).
...
4. **Контур записей (публичный VPS):** [PUBLIC_RECORDINGS.ru.md](./public-recordings.ru.md).
...
Сообщить об уязвимости: GitHub Security Advisory или maintainers. См. [политику безопасности](https://github.com/Gfermoto/BirdLense-Hub/blob/main/SECURITY.md) в корне репозитория.
