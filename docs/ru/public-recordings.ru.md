...
| 2 | **`BIRDLENSE_STRICT_API_AUTH=1`** + [прод-гейты](https://github.com/Gfermoto/BirdLense-Hub/blob/main/AGENTS.md#production-gates) | Закрывает изменяющие **`/api/ui/*`**; многие read-only GET дашборда остаются публичными по [ACCESS_CONTROL.ru.md](./ACCESS_CONTROL.ru.md). |
...
- [DEPLOY_SERVER.ru.md §8](./DEPLOY_SERVER.ru.md)  
- [CONFIGURATION.ru.md](./CONFIGURATION.ru.md)  
- [ACCESS_CONTROL.ru.md](./ACCESS_CONTROL.ru.md)  
