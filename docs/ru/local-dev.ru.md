...
[English](../contributor/local-dev.md)
...
**VS Code:** открывайте репозиторий с корня; для сборки UI в терминале сначала `cd app/ui`, чтобы подтянулась нужная версия Node.
