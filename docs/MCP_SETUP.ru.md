...
**MCP** — способ подключить внешние клиенты (редакторы, скрипты) к инструментам BirdLense Hub поверх вашего OpenAPI.
...
Добавьте ниже фрагмент в настройки MCP вашего редактора или клиента (путь к файлу зависит от продукта). **Не коммить** токены.
...
Чтобы клиент читал **Markdown из GitHub** (`docs/`, `README` и т.д.) без запущенного Hub, добавьте [GitMCP](https://gitmcp.io):
