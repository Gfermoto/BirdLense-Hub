...
- Offline **DINOv2 crop embeddings** CLI: [`embed_dinov2_crop.py`](../scripts/reid/embed_dinov2_crop.py), [`embed_cosine_report.py`](../scripts/reid/embed_cosine_report.py), [`export_crops_from_sqlite.py`](../scripts/reid/export_crops_from_sqlite.py), [`README`](../scripts/reid/README.md) — outside Docker ([#383](https://github.com/Gfermoto/BirdLense-Hub/issues/383)).
