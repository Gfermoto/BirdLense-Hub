...
|-------|--------|----------------|
| [#367](https://github.com/Gfermoto/BirdLense-Hub/issues/367) Эпик | **Открыто (execution tracking)** | Repo-scope база доставлена, но после аудита acceptance criteria заново открыты execution-задачи: [#379](https://github.com/Gfermoto/BirdLense-Hub/issues/379), [#389](https://github.com/Gfermoto/BirdLense-Hub/issues/389), [#390](https://github.com/Gfermoto/BirdLense-Hub/issues/390), [#392](https://github.com/Gfermoto/BirdLense-Hub/issues/392). |
...
| [#390](https://github.com/Gfermoto/BirdLense-Hub/issues/390) Re-ID productization | **Открыто (execution pending)** | Policy/gates в репо есть, но issue остаётся открытым до реализации продуктового review/merge UX и измеримой quality-валидации. |
...
- [#390] Re-ID safety: RFC [ML_REID_PRODUCTIZATION.ru.md](ML_REID_PRODUCTIZATION.ru.md) + **YAML policy** (`processor.reid_*`) + **`video_reid_match@v2`** hints + shadow/A-B validation plan; execution DoD ещё открыт.
