...
1. **Перед релизом:** обновить `VERSION`, `package.json`, `openapi.yaml`, `CHANGELOG.md`; закрыть/обновить **Issues** и доску **Roadmap** ([ROADMAP.ru.md](./ROADMAP.ru.md) § *Отчётность*, корневой [CONTRIBUTING.ru.md](https://github.com/Gfermoto/BirdLense-Hub/blob/main/CONTRIBUTING.ru.md)).
