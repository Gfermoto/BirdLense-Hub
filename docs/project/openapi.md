...
UI: где типы всё ещё «ручные» относительно сгенерированного контракта — [UI API manual contracts](UI_API_MANUAL_CONTRACTS.md) (issue [#343](https://github.com/Gfermoto/BirdLense-Hub/issues/343)).
