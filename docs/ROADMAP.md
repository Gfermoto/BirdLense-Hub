...
| ✅ Сравнение с регионом               | «У вас N видов. В топ-20 региона — M из них» — eBird API, регион из настроек                 | Высокая   | Средний |
...
| 6 | Неизвестные — выбор часа | Подсказка: «При выборе времени (не 00:00) — только этот час.» | ✅ v0.1.8 |
