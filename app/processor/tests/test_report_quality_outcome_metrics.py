...
class TestReportQualityOutcomeMetrics(unittest.TestCase):
    ...
    def test_latency_p95_excludes_fp_empty_recording_sessions(self):
        from report_quality_outcome_metrics import evaluate
        ...
        fp_payload = {
            ...
            "trigger_to_first_bbox_latency_s": 30.0,
        }
        hit_payload = {
            "trigger_source": "frigate",
            "trigger_graph": {
            ...
            "trigger_to_first_bbox_latency_s": 4.0,
        }
        rows = [
            {
                "yolo_frames_ran": 40,
        ...
        self.assertEqual(
            report["metrics"]["trigger_to_first_bbox_latency_p95_s"],
            4.0,
        )
