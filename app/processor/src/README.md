...
| `behavior` | [behavior/](../models/behavior/README.md) | Meta + video behavior labels | `behavior_baseline_runtime.py`, `behavior_video_runtime.py`, `behavior_openvino_runtime.py` | `processor.behavior_recognition`, models/behavior |
