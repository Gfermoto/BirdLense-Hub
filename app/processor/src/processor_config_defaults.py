...
# Soft near-miss events (below best-guess min) kept for site-prior re-rank / rescue.
CLASSIFIER_SOFT_EVENTS_ENABLED = True
CLASSIFIER_SOFT_MIN_CONFIDENCE = 0.01
...
MIN_TRACK_DURATION = 0.15
TRACKER_REMEMBER_SECONDS = 2.4
ULTRA_WEAK_BOX_SALVAGE_ENABLED = False
TRACK_TO_PREDICT_FALLBACK_ENABLED = True
TRACKER_ADAPTIVE_MIN_BUFFER = 6
TRACKER_ADAPTIVE_MAX_BUFFER = 24
TRACKER_LOW_FPS_THRESHOLD = 10.0
# Detect substream letterbox (WxH) — YOLO runs here, not main/record native resolution.
