        ...
        with flask_app.app_context():
            ...
            for video in videos:
                ...
                try:
                    ...
                    if not detections:
                        reason = (
                            'no_detections_after_precise_pass' if precise_used
                            else 'no_detections_fast_run'
                        )
                        skipped += 1
                        precise_candidates.append({
                            'video_id': video.id,
                    ...
                    if manual_vs:
                        ...
                        if not parallel_auto_with_manual:
                            unmatched = [
                                ...
                                if not manual_conflict_with_detection(
            ...
            flask_app.logger.info(
                ...
                generated, frames_updated, failed, skipped,
            )
