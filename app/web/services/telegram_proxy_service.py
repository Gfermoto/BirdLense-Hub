...
PROXY_LIST_URLS = (
    'https://raw.githubusercontent.com/proxygenerator1/ProxyGenerator/main/'
    'MostStable/socks5.txt',
    'https://raw.githubusercontent.com/proxygenerator1/ProxyGenerator/main/'
    'Stable/socks5.txt',
)
...
def refresh_telegram_proxy(
    *,
    ...
    current_type = (
        app_config.get('notifications.telegram_proxy_type') or ''
    ).strip()
    current_url = (
        app_config.get('notifications.telegram_proxy_url') or ''
    ).strip()
