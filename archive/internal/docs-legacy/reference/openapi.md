...
If the frame is empty (offline or blocked), open [the YAML on GitHub](https://github.com/Gfermoto/BirdLense-Hub/blob/main/app/web/openapi.yaml) or import the file into Swagger / Stoplight.
