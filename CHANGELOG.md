...
- **Tech debt:** эпик [#220](https://github.com/Gfermoto/BirdLense-Hub/issues/220); уровни [#221](https://github.com/Gfermoto/BirdLense-Hub/issues/221)–[#225](https://github.com/Gfermoto/BirdLense-Hub/issues/225) на доске [BirdLense Hub — Roadmap](https://github.com/users/Gfermoto/projects/2); [#198](https://github.com/Gfermoto/BirdLense-Hub/issues/198) / [#201](https://github.com/Gfermoto/BirdLense-Hub/issues/201) — сводные темы. [ROADMAP.ru.md](docs/ROADMAP.ru.md) — **волна D** (только отсылка).
