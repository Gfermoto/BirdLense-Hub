...
- **CI: CodeQL** — workflow `.github/workflows/codeql.yml` (Python `app/web` + `app/processor`, TypeScript `app/ui/src`), конфиги `.github/codeql/`; доки [CODEQL](docs/CODEQL.md) / [RU](docs/CODEQL.ru.md), пункты в mkdocs и SITE_MAP.
